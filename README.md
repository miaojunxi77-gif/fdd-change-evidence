...
- Item 10 financing: Production V1 contains 11,102 reconciled brand-years, 11,001 paper-ready observations, and 101 intentionally unresolved score conflicts. The financing page reports the 0–4 risk ladder, prevalence, annual trends, sensitivity bounds, and 5,647 consecutive within-brand year pairs.
...
- `public/data/item10-financing/` contains only derived financing summary tables; the production panel and original Item 10 texts are not published on the website.
